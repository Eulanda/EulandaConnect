...
Function Remove-RemoteFile {
    ...
    <# Test:
        ...
        Remove-RemoteFile -server $server -protocol sftp -user $user -password $secure -remoteFolder /inbox -remoteFile 'Readme.md'
...
Function Send-RemoteFile {
    ...
    <# Test:
        ...
        Send-RemoteFile -server $server -protocol sftp -user $user -password $secure -remoteFolder "/inbox" -localFolder $pesterFolder -localFile 'Readme.md'
        $result = Get-RemoteDir -server $server -protocol sftp -user $user -password $secure -remoteFolder "/inbox"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAu9zHngWQzHUYj
# EPlg1YEVS2lNcME0+vZHpiDIiIajdKCCElYwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# BDEiBCCvuJDGBi2Bkk8smK7LFonVh3jEh2aSMCqLOIc0TiyIVDANBgkqhkiG9w0B
# AQEFAASCAgAJ0J0t+36PZqigMoz+Cp8G30SC9WXwoqnh/y0ldH5lgecvZMJ/HbA8
# TIUgLIO7jIgv9xSXoFsCHTwlJ7acRHEd80+Ijn7K/BOPrBfovGlc14/EdDg1mrG1
# oUf1TBbJYzz8eLF0KvV0TF5n0DZrBSl02HCe8oFVfHWM0ptHqDMB49MIDNpso0OX
# Sh3deKjX+k/Z+38J1jcEVTUnRYtexDaMpixXel6mRP8QeYdjq6zpGwWRLLfdmmAb
# Rs+cpobymhLgHTu+Jrh33w3CdRQ3dVSvD3YqNmILyB4Kil/Z0QXztEo2QS8Srvc8
# ntZcO9hPDQqGok+oS/clGyKTWCait6OIvb2TQX0tpHaZyLZLHGj3i5ZfQxl7WOsS
# 4Y7iZKUFuU9B5umzMMfhRaX0egE0bSvY+QymEBUhYhw+k1z7Wuk3bPUmXqjOqd3+
# 9b64JAZkoTqiKRvxN+sSCYCVbyHI694+4JGwcmegXBqzeQOxgQcy5vhf8rRsVcm2
# AWzknPQfiYnLEcun3JPAiZnIg0Do/wErKHoranpYDmc5UxV7zIpoY+G+kDEeHGTN
# yhCyEPGId+8fj5vx2KmRIr8SjYxUyR6y2WT3k9FcRezDJYnHm42fV1urh+KzWkQQ
# uyaO8ypMPapEislLkdwyMRB0WNZrmt0cW/PVkOBad69VcUP7fsC8KqGCE04wghNK
...
# AgEBMDEwDQYJYIZIAWUDBAIBBQAEIH0iYAor7i2+NWJVoQWMbZQ+BGYe8Dsbf3fs
# nVOYL474AhQlBuf1UM9z52N/82RIgEt+m/j6ehgPMjAyNDAyMjUxNzAzMzRaoG6k
...
# 9w0BCQUxDxcNMjQwMjI1MTcwMzM0WjA/BgkqhkiG9w0BCQQxMgQw1cQdHgTdJbcu
# 6/fyLBIOdZAk0kXjhAtt6CPtd9ybyPfKe9kGUVBnxeTRkT5KHbFeMIHtBgsqhkiG
...
# DQEBAQUABIICAH3Uw8fxFk4QGU133VQYHCg9AaU33c9OI+o+LIEamehwL7mb84UU
# jdLlmbR/BeCzO565TvKR0vZh5Z5FulqfMN+5fhXoOCg6v41ExuqAnzIJcYQv8XDt
# oABTgM3VtzG3joMaxGLGwjlis3vEm65nj3ovdc3Skk8VThxR0/3CZZGrbPaA3bXd
# YVb7wBsPC2OpPdMCHAOmeR+EuDETLyYMyHR0VN1komklpT5LlaKgItdNymieBBjr
# UvYKCum/ePA0pO+YJOgE0a6RzpxqeIc+VLCUqukr+43aQGo0LURvbMeNSVYqIsCn
# +Gp1+qiSv0cvaQ5tjUVnUyPx5ANbq9oxXo53KmLIual4V/9sOTnz2KfjOG1RkbHF
# DVAjaaBKkdwM6BqdB90Zn5TXeuFuPnGQXMcdOfiV7gXiSI1pvEegqnTyKgWpSyuj
# 9UBS1hqTMoBsg9NAQVqPihIjmonVCixc/eoMUWLUVyQ37gOmVtl7C0P7VZAQ3Q90
# TpfDKxKU0wgtELi/IPvxFNGKSdOC7PfqjwY3ML1vSVmbFfaQ40rTlNNZ4fLHhGwl
# FP41uSi5UvLmRsTwINKzlp9hItoB5ypI0iZxGl72wAE8M3KDDUX62lxZ8Dc9XItr
# 9PfIKV3/tvygF75Q7XeQI8j3h62+BmPHHJmiJzuSzM1K+3uBA2tqpoPp
